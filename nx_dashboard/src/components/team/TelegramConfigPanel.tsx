...
import { TelegramConversationsPanel } from './TelegramConversationsPanel';
...
type TabKey = 'config' | 'conversations';
...
export function TelegramConfigPanel({ teamId, onClose }: TelegramConfigPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={onClose} />
      <div className="relative w-full max-w-3xl bg-card rounded-2xl shadow-2xl border border-border/50 overflow-hidden max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-border/50 bg-gradient-to-r from-blue-500/5 to-cyan-500/5 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold">Telegram 集成</h2>
        ...
        <div className="flex border-b border-border/50 flex-shrink-0">
          {[
            { key: 'config' as TabKey, label: '成员 Bot', icon: Settings },
            { key: 'conversations' as TabKey, label: '会话记录', icon: MessageCircle },
        ...
        {activeTab === 'config' ? (
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              <input
                                ...
                                onBlur={() =>
                                  row.botToken.trim() && autoFetchChatId(member.role_id)
                                }
          ...
          <div className="flex-1 overflow-hidden">
            <TelegramConversationsPanel teamId={teamId} />
          </div>
        )}
      </div>
    </div>
