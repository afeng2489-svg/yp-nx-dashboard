  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="max-w-[150px] truncate">{currentWorkspace?.name || '选择项目'}</span>
        <ChevronDown
          className={cn(
      ...
      {showPathInput && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-card rounded-xl border border-border shadow-xl w-96 p-6">
            ...
            {inputError && <p className="text-sm text-red-500 mt-2">{inputError}</p>}
