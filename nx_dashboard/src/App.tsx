...
const WisdomPage = lazy(() => import('@/pages/WisdomPage').then(m => ({ default: m.WisdomPage })));
        ...
        <Suspense fallback={<PageLoadingFallback />}>
          <Routes>
            <Route element={<Dashboard />}>
              ...
              <Route path="/workflows" element={<PageWrapper><WorkflowsPage /></PageWrapper>} />
              <Route path="/templates" element={<PageWrapper><TemplatesPage /></PageWrapper>} />
              <Route path="/executions" element={<PageWrapper><ExecutionsPage /></PageWrapper>} />
              <Route path="/terminal" element={<PageWrapper><TerminalPage /></PageWrapper>} />
              <Route path="/editor" element={<EditorPage />} />
              <Route path="/sessions" element={<PageWrapper><SessionsPage /></PageWrapper>} />
              ...
              <Route path="/ai-settings" element={<PageWrapper><AISettingsPage /></PageWrapper>} />
